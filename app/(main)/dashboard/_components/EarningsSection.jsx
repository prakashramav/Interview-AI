    ...
    <section className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div
            key={stat.label}
            className="bg-[#111112] border border-white/10 rounded-2xl p-6 flex flex-col gap-2"
          >
      ...
      <div className="bg-[#f0f0f5] border border-white/10 rounded-2xl p-8 flex items-center justify-between gap-4">
        <div>
